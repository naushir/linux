...
static int map_ls_table(struct bcm2835_isp_dev *dev,
			const struct bcm2835_isp_lens_shading *v4l2_ls)
{
	...
	dev->last_ls_dmabuf = v4l2_ls->dmabuf;
...
static int bcm2835_isp_s_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	case V4L2_CID_USER_BCM2835_ISP_LENS_SHADING:
	{
		...
		if (v4l2_ls->dmabuf != dev->last_ls_dmabuf)
			ret = map_ls_table(dev, v4l2_ls);
